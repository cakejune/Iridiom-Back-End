...
new_idioms_xy = [
  "8,4", "8,3", "8,2", "7,2", "6,2", "5,2", "4,2", "3,2", "2,2", "1,2",
  "0,2", "9,2", "10,2", "11,2", "12,2", "13,2", "14,2", "15,2", "16,2", "17,2",
  "8,5", "8,6", "8,7", "7,7", "6,7", "5,7", "4,7", "3,7", "2,7", "1,7",
  "0,7", "9,7", "10,7", "11,7", "12,7", "13,7", "14,7", "15,7", "16,7", "17,7",
  "7,4", "6,4", "5,4", "9,4", "10,4", "11,4", "7,5", "6,5", "5,5", "9,5"
  ]

# Loop through the Idiom instances and update their xy coordinates
(119..172).each_with_index do |id, index|
  idiom = Idiom.find_by(elNum: id)
  idiom.update(xy: new_idioms_xy[index])
end


# New idioms with xy coordinates
# new_idioms_xy = [  "2,2", "2,4", "2,6", "4,1", "4,3", "4,5", "4,7", "6,2", "6,4", "6,6",  "8,0", "8,2", "8,4", "8,6", "10,1", "10,3", "10,5", "10,7", "12,0", "12,2",  "12,4", "12,6", "14,1", "14,3", "14,5", "14,7", "16,0", "16,2", "16,4", "16,6",  "0,1", "0,3", "0,5", "0,7", "1,0", "3,0", "5,0", "7,0", "9,0", "11,0",  "13,0", "15,0", "17,2", "17,4", "17,6", "9,2", "9,4", "9,6", "4,0",  "6,0", "10,0", "12,0", "14,0", "16,0"]


# # Iterate through the new idioms and create them
# new_idioms_xy.each_with_index do |xy, index|
#   # Generate a random abbreviation with 2 characters
#   abbr = Faker::Alphanumeric.alpha(number: 2).capitalize

#   # Generate a random meaning
#   meaning = Faker::Lorem.sentence(word_count: 10)

#   # Set the usage to a sample string
#   usage = "This idiom can be used in many ways."

#   # Set the category to a sample string
#   category = "Miscellaneous"

#   # Create the new idiom with the given attributes
#   new_idiom = Idiom.create(elNum: index+119, abbr: abbr, phrase: "#{abbr} phrase", meaning: meaning, usage: usage, xy: xy, category: category)

#   # Output the created idiom to the console
#   puts "Created idiom with id: #{new_idiom.id}"
# end
